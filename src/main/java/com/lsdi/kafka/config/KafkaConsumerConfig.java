...
public class KafkaConsumerConfig {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, Long> filterKafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, Long> factory = kafkaListenerContainerFactory("filter");
        factory.setRecordFilterStrategy(record -> record.value() < 100);
        return factory;
    }
