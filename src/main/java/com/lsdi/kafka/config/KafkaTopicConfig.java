...
public class KafkaTopicConfig {
    ...
    @Value(value = "${squared.topic.name}")
    private String squaredTopicName;
    ...
    public NewTopic topic1() {
        return new NewTopic(streamTopicName, 1, (short) 1);
    }

    @Bean
    public NewTopic topic2() {
        return new NewTopic(squaredTopicName, 1, (short) 1);
    }
